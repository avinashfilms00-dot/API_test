...
public class BfhlControllerTest {
    ...
    public void testExampleA() throws Exception {
        ...
        mockMvc.perform(post("/bfhl")
                ...
                .andExpect(jsonPath("$.user_id", is("manish_yadav_24121996")))
                .andExpect(jsonPath("$.email", is("manishyadav241296@acropolis.in")))
                .andExpect(jsonPath("$.roll_number", is("0827CI243D06")))
